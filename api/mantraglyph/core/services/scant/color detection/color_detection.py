...
img_path = "scant\scant\Images\\22.jpg"
...
csv = pd.read_csv('scant\scant\color detection\colors.csv', names=index, header=None)
...
while(1):
    # cv2.namedWindow('color detection by programming_fever',cv2.WINDOW_NORMAL)
